...
//int equal_cols(const vec_t *mat, const ind_t dim, const ind_t i, const ind_t j);
//vec_t scalar_product(const ind_t lim, const vec_t v1, const vec_t v2);
